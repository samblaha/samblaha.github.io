...
To enable the Project Requests comment section with upvoting, follow these steps:
...
3. Select the **Project Requests** category
4. Copy the `data-repo-id` and `data-category-id` values

## 5. Update the Configuration

Edit `_layouts/home.html` and replace the empty values:
...
- ✅ Users can post project requests
- ✅ Upvote/react to requests with emoji reactions
- ✅ Comments and discussion on each request
